...
namespace MoreLockedDoors.Locks
{
    internal class CustomLockSaveDataProxy
    {
        ...
        public bool m_IsBrokenOpen { get; set; }
        public List<string> m_ItemsUsedToForceLock { get; set; }
        public string m_LockedAudio { get; set; }
        public string m_Pair { get; set; }

        public CustomLockSaveDataProxy(LockState lockState, bool IsBrokenOpen, List<string> itemsUsedToForceLock, string lockedAudio, string pair)
        {
            m_LockState = lockState;
            m_IsBrokenOpen = IsBrokenOpen;
