...
namespace MoreLockedDoors.Patches
{
    internal class Patches : MelonMod
    {
        ...
        public static void AddCustomLock_Test(LockManager lockManager)
        {
        ...
        public static void AddMysteryLakeLocks(LockManager lockManager)
        {
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "LakeRegion")
            {
                ...
                lockManager.InitializeLock(damFrontGateObj, 70, lockManager.metalChainDoorLockedAudio, "", "HydroDamGate", "", Items.boltcutters.GetComponent<GearItem>());
            }
            else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "CampOffice")
            {
                GameObject campOfficeFrontDoor = GameObject.Find(Paths.campOfficeFrontDoorInt);
        ...
        public static void AddMountainTownLocks(LockManager lockManager)
        {
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "MountainTownRegion")
            {
                ...
                lockManager.InitializeLock(bankFrontDoorObj, 50, lockManager.woodDoorLockedAudio, "", "MiltonBankDoor", "", Items.prybar.GetComponent<GearItem>());
        ...
        public static void AddBrokenRailroadLocks(LockManager lockManager)
        {
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "TracksRegion")
            {
                ...
                lockManager.InitializeLock(lodgeGateObj, 60, lockManager.metalChainDoorLockedAudio, "", "HuntingLodgeGate", "", Items.boltcutters.GetComponent<GearItem>());
                ...
                {
                    lockManager.InitializeLock(door, 80, lockManager.metalDoorLockedAudio, GUIDs[i], doorNames[i], interiorDoorNames[i], Items.prybar.GetComponent<GearItem>());
                    i++;
                }
            }
            else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "MaintenanceShedA")
            {
                ...
                foreach (var door in doors)
                {
                    lockManager.InitializeLock(door, 80, lockManager.metalDoorLockedAudio, GUIDs[i], doorNames[i], exteriorDoorNames[i], Items.prybar.GetComponent<GearItem>());
                    i++;
                }
        ...
        public static void AddDesolationPointLocks(LockManager lockManager)
        {
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "WhalingStationRegion")
            {
                ...
                {
                    lockManager.InitializeLock(mine5door1, 40, lockManager.metalChainDoorLockedAudio, "27abfb4e-d322-4b64-b1a8-d382cee053af", "MineNo5Door1Ext", "MineNo5Door1Int", Items.hacksaw.GetComponent<GearItem>());
                    lockManager.InitializeLock(mine5door2, 40, lockManager.metalChainDoorLockedAudio, "a358f1a0-1af4-4faa-9f00-0b77fa1ff114", "MineNo5Door2Ext", "MineNo5Door2Int", Items.hacksaw.GetComponent<GearItem>());
                }
                ...
                lockManager.InitializeLock(hiberniaFrontDoor, 60, lockManager.metalDoorLockedAudio, "5805f636-2b63-4bda-a468-750bef9b0ac6", "HiberniaFrontDoorExt", "HiberniaFrontDoorInt", Items.prybar.GetComponent<GearItem>());
                lockManager.InitializeLock(hiberniaBackDoor, 60, lockManager.metalDoorLockedAudio, "61299ab5-b6ac-420a-bbdc-4e4787c7b461", "HiberniaBackDoorExt", "HiberniaBackDoorInt", Items.prybar.GetComponent<GearItem>());
            ...
            else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "WhalingWarehouseA")
            {
                ...
                lockManager.InitializeLock(hiberniaFrontDoor, 60, lockManager.metalDoorLockedAudio, "8497788f-28d1-4a17-baab-f3a6b98100f2", "HiberniaFrontDoorInt", "HiberniaFrontDoorExt", Items.prybar.GetComponent<GearItem>());
                lockManager.InitializeLock(hiberniaBackDoor, 60, lockManager.metalDoorLockedAudio, "ed87b39e-addb-457a-8abf-81d7bfa4a97e", "HiberniaBackDoorInt", "HiberniaBackDoorExt", Items.prybar.GetComponent<GearItem>());
            ...
            else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "WhalingMine")
            {
                ...
                lockManager.InitializeLock(mine5door1Int, 40, lockManager.metalChainDoorLockedAudio, "d61e4ad1-6e4a-47bf-a5ed-696070a88399", "MineNo5Door1Int", "MineNo5Door1Ext", Items.hacksaw.GetComponent<GearItem>());
                lockManager.InitializeLock(mine5door2Int, 40, lockManager.metalChainDoorLockedAudio, "1d06bcf8-fc72-4c47-ad3d-ed2f5455d5b2", "MineNo5Door2Int", "MineNo5Door2Ext", Items.hacksaw.GetComponent<GearItem>());
        ...
        public static void AddCoastalHighwayLocks(LockManager lockManager)
        {
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "CoastalRegion")
            {
                ...
                {
                    lockManager.InitializeLock(quonsetFrontDoor, 70, lockManager.metalDoorLockedAudio, "8939b09a-3b9b-4b2c-9ced-cde4bc8ad171", "QuonsetFrontDoorExt", "QuonsetFrontDoorInt", Items.prybar.GetComponent<GearItem>());
                    lockManager.InitializeLock(quonsetBackDoor, 70, lockManager.metalDoorLockedAudio, "9991f9bb-0c1a-48b3-81a8-8ce883ccd389", "QuonsetBackDoorExt", "QuonsetBackDoorInt", Items.prybar.GetComponent<GearItem>());
                }
                ...
                lockManager.InitializeLock(cinderHillsCoalMineDoor, 90, lockManager.metalChainDoorLockedAudio, "27abfb4e-d322-4b64-b1a8-d382cee053af", "CinderHillsMineDoorExt", "CinderHillsCoalMineDoorInt", Items.hacksaw.GetComponent<GearItem>());
            ...
            else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "QuonsetGasStation")
            {
                ...
                lockManager.InitializeLock(quonsetFrontDoor, 70, lockManager.metalDoorLockedAudio, "a40c7e13-86b4-4a04-9a50-16f78bd14d8e", "QuonsetFrontDoorInt", "QuonsetFrontDoorExt", Items.prybar.GetComponent<GearItem>());
                lockManager.InitializeLock(quonsetBackDoor, 70, lockManager.metalDoorLockedAudio, "e6910ab2-75ec-4df5-adb2-8f3a4c76ecaa", "QuonsetBackDoorInt", "QuonsetBackDoorExt", Items.prybar.GetComponent<GearItem>());
            }
        }
        public static void AddCinderHillsCoalMineLocks(LockManager lockManager)
        {
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "MineTransitionZone")
            {
                ...
                lockManager.InitializeLock(cinderHillsCoalMineDoorCH, 90, lockManager.metalChainDoorLockedAudio, "adb77a85-783e-4fc6-bd50-07bd264efe44", "CinderHillsMineDoorInt", "CinderHillsMineDoorExt", Items.hacksaw.GetComponent<GearItem>());
        ...
        public static void AddPleasantValleyLocks(LockManager lockManager)
        {
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "RuralRegion")
            {
                ...
                {
                    lockManager.InitializeLock(ruralStoreFrontDoor, 70, lockManager.woodDoorLockedAudio, "c17a1359-75ee-43fa-ace4-b76819fdaa9b", "RuralStoreFrontDoorExt", "RuralStoreFrontDoorInt", Items.prybar.GetComponent<GearItem>());
                    lockManager.InitializeLock(ruralStoreBackDoor, 70, lockManager.woodDoorLockedAudio, "138894f7-7fd0-4c97-be36-1f350cb93499", "RuralStoreBackDoorExt", "RuralStoreBackDoorInt", Items.prybar.GetComponent<GearItem>());
                }

                //Lock Radio Control Hut
                GameObject signalHillDoor = GameObject.Find(Paths.signalHillDoor);
                lockManager.InitializeLock(signalHillDoor, 80, lockManager.metalDoorLockedAudio, "", "SignalHillDoorExt", "", Items.prybar.GetComponent<GearItem>());
            }
            else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "RuralStoreA")
            {
                ...
                lockManager.InitializeLock(ruralStoreFrontDoor, 70, lockManager.woodDoorLockedAudio, "e5cb7bfa-5c37-4fef-a57e-7fac7174aaa3", "RuralStoreFrontDoorInt", "RuralStoreFrontDoorExt", Items.prybar.GetComponent<GearItem>());
                lockManager.InitializeLock(ruralStoreBackDoor, 70, lockManager.woodDoorLockedAudio, "30ce35d1-f08b-43e4-abdd-c8f226352afc", "RuralStoreBackDoorInt", "RuralStoreBackDoorExt", Items.prybar.GetComponent<GearItem>());
            ...
            else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "CommunityHallA")
            {
                ...
                lockManager.InitializeLock(communityHallFrontDoorInt, 70, lockManager.woodDoorLockedAudio, "a30c0c66-7117-4359-bcad-f7b75ea1ccaf", "CommunityHallFrontDoorInt", "CommunityHallFrontDoorExt", Items.communityHallKey.GetComponent<GearItem>());
                lockManager.InitializeLock(communityHallBackDoorInt, 70, lockManager.woodDoorLockedAudio, "87d6326a-f32b-4e87-968e-39b48d9e1a3f", "CommunityHallBackDoorInt", "CommunityHallBackDoorExt", Items.communityHallKey.GetComponent<GearItem>());
            }
        ...
        public static void AddBlackrockLocks(LockManager lockManager)
        {
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "BlackrockRegion")
            {
                ...
                lockManager.InitializeLock(substationDoor, 60, lockManager.metalDoorLockedAudio, "f4bc3103-7108-4d80-9b0d-2e83864983c7", "SubstationDoorExt", "SubstationDoorInt", Items.prybar.GetComponent<GearItem>());
            }
            else if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "RadioControlHutC")
            {
                ...
                lockManager.InitializeLock(substationDoor, 60, lockManager.metalDoorLockedAudio, "a0fb16ec-8fb0-48e1-aa38-8e4760b24410", "SubstationDoorInt", "SubstationDoorExt", Items.prybar.GetComponent<GearItem>());
            }
        }
        ...
        internal class Lock_Awake
        {
            ...
            public static bool Prefix(Lock __instance)
            {
                ...
                if (paths.Any(Paths.GetObjectPath(obj).Contains))
                {
                    return false;
                }
                else
